...
const Notifications: FC<NotificationsProps> = (props) => {
  ...
  return (
    <div ref={notificationsRef}>
      ...
      {
        open && <Paper className="customScrollBar z-10 dark:text-white text-black w-[280px] h-[50vh] bg-white border-[1px] dark:border-gray-600 rounded-sm dark:bg-[#111C43] absolute bg-[--t-blue] top-12 right-6 pt-2  overflow-y-scroll">
