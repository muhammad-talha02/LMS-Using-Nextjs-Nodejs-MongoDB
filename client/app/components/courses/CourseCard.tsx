...
const CourseCard: FC<Props> = ({ item, isProfile }) => {
    ...
    return (
        <Link href={`/courses/course/${item._id}`}>
            <div className='w-full h-[325px] dark:bg-slate-900 backdrop-blur border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner'>
